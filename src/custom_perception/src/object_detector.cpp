...
#include <custom_robot_interfaces/srv/detect_objects.hpp>
...
public:
    explicit ObjectDetector(const rclcpp::Node::SharedPtr& node)
        ...
        detect_service_ = node_->create_service<custom_robot_interfaces::srv::DetectObjects>(
...
private:
    ...
    void on_detect_service(
        const std::shared_ptr<custom_robot_interfaces::srv::DetectObjects::Request>,
        const std::shared_ptr<custom_robot_interfaces::srv::DetectObjects::Response> response
    ) {
        std::lock_guard<std::mutex> lock(latest_mutex_);
    ...
    rclcpp::Service<custom_robot_interfaces::srv::DetectObjects>::SharedPtr detect_service_;
