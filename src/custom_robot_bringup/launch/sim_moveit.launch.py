...
def generate_launch_description():
    declared_arguments = [
        ...
        DeclareLaunchArgument(
            ...
            default_value=PathJoinSubstitution(
                [FindPackageShare("custom_robot_description"), "config", "initial_positions.yaml"]
            ),
        ),
    ...
    sim_control_launch = IncludeLaunchDescription(
        PythonLaunchDescriptionSource(
            PathJoinSubstitution(
                [FindPackageShare("custom_robot_bringup"), "launch", "sim_control.launch.py"]
            )
        ),
        launch_arguments={
    ...
    moveit_launch = IncludeLaunchDescription(
        PythonLaunchDescriptionSource(
            PathJoinSubstitution(
                [FindPackageShare("custom_moveit_config"), "launch", "moveit.launch.py"]
            )
        ),
        launch_arguments={
            "safety_limits": LaunchConfiguration("safety_limits"),
